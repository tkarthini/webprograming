...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // You can handle form data processing here if needed

    // No need to redirect here since the form action will handle the redirection
}
...
<head>
    ...
    <link rel="stylesheet" href="viewjob_student.css">
</head>
