...
<body>
    ...
    <section id="scrollToSection" class="hero">
        <div class="container">
            <img src="images/logo.png" alt="InternHub Logo">
    ...
    <div class="content1">
        ...
        <img src="images/about%20us.png" alt="About Us Image">
    </div>

    <div class="content2">
        <img src="images/about%20us%202.png" alt="About Us Image 2">
        <div class="text2">
            <h3>Why InternHub?</h3>
    ...
    <section class="two-column-section">
        <div class="columnL">
            <h2>For Students</h2>
            <img src="images/for%20students.png" alt="For Students">
        ...
        <div class="columnR">
            <h2>For Companies</h2>
            <img src="images/for%20companies.png" alt="For Companies">
