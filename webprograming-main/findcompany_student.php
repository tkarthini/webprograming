...
<head>
  ...
  <link rel="stylesheet" href="findcompany_student.css">
</head>
<body>
  <header>
        <div class="container">
  ...
  <div class="box-container">
    ...
    <!-- Dummy Company Card -->
    <div class="box">
      <img src="imini.png" alt="Dummy Job Image" class="box-image">
      <div class="box-details">
        <h2>IMini Sdn Bhd</h2> 
    ...
    <div class="box">
      <img src="yeabusiness.png" alt="Dummy Job Image" class="box-image">
      <div class="box-details">
    ...
    <div class="box">
      <img src="karisma.png" alt="Dummy Job Image" class="box-image">
      <div class="box-details">
