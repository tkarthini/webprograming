...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="css/applicationsuccess_student.css">
      </head>
      <body>
        <header>
    <div class="container">
      ...
      <ul>
        ...
        <div class="content">
            <h1 id="goodluck">Good luck,Sinan Teoman!</h1>
            <p>Your Application Has Been Sent To BUZZWORKS FILMS SDN BHD</p>
        </div>
