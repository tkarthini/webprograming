...
<head>
    ...
    <title>InternHub - Yea Business</title>
...
<body>
    ...
    <div id="Background">
        <img id="Buzzbackground" src="images/yeabusinesscoverpic.jpg" width="100%" height="60%">
        <img id="Buzz" src="images/yeabusiness.png" width="300px" height="300px">
    </div>

    <section id="scrollToSection" class="hero">
        <section class="three-column-section">
            <h1>Yea Business Sdn Bhd</h1>
        </section>
        <p>Petaling Jaya, Malaysia</p>
        <h3>Company overview</h3>
        <p>Industry: Broadcast Media, Entertainment and Publishing<br>
            Company size: 1-10 employees<br>
            Primary location: 3 Jalan PJS 11/11 Bandar Sunway Petaling Jaya 46150</p>
        <div class="content">
            <h3>Who We Are</h3>
            <p>We look more like a modern management consultancy solving major problems for businesses. From marketing strategy and web experience to lead generation. Every day we take on significant business challenges that increase enterprise value. YEA Business is more about a business partner to brand e-commerce in South East Asia. Boost your online sales with YEA BUSINESS - a full service ecommerce agency specializing in driving growth and maximizing conversions. Contact us today!</p>
    ...
    <section class="two-column-section">
        <div>
            ...
            <a href="viewjob(UIUXyea)_student.php"><button>Apply</button></a>
        </div>
        <div>
