...
<head>
    ...
    <title>InternHub - Kiveena Seetha</title>
...
<body>
    ...
    <body>
        <div class="content">
            <img id="profilebackground" src="images/student profile background 2.jpg" width="100%" height="60%">
            <img id="profilepicture" src="images/Kiveena%20Seetha.png" width="300px" height="400px">
        </div>

        <section id="scrollToSection" class="hero">

            <div>
                <h3 id="Name">Kiveena Seetha
                ...
                <p id="ssummary">Passionate and dedicated Theater Arts student with a keen eye for detail and a love for storytelling. Skilled in various aspects of theater production, including acting, directing, stage management, and technical design. Proficient in collaborating with diverse teams to bring creative visions to life on stage. Possesses strong communication and organizational skills, along with a deep understanding of theatrical history and theory. Eager to contribute creativity, energy, and a commitment to excellence to any theatrical project or production.</p>
            </div>

            <div>
                <h4 id="Skills">Skills</h4>
                <button id="FilmAnalysis">Script Analysis</button>
                <button id="CriticalThinking">Sound Design</button>
                <button id="CommunicationSkills">Costume Design</button>

            </div>

            <div>
                <button id="VisualLiteracy">Stage Management</button>
                <button id="MediaProductionSkills">Makeup and Special Effects</button>
            </div>

            <h4 id="Education">Education</h4>
            <button id="year">Present - 2021</button>
            <ul>
                <li id="li">Bachelors in Theater Arts, university of New Zealand</li>
            </ul>
            <button id="year">2021 - 2018</button>
            <ul>
                <li id="li">Diploma in Theater Art, university of New York</li>
            </ul>
            ...
            <p id="email">kiveenaas0014@gmail.com</p>

            <h4 id="llocation">Location</h4>
            <p id="location">Pahang, Malaysia</p>
    ...
    <script>
        function openResume() {
            ...
            var resumeImage = "images/resume_kiveena.png";
